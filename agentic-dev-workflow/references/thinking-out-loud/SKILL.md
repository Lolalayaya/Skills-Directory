...
description: >-
  ...
  messages and an optional targeted interview. Produces an approved brief, not
  a design — if the approved brief describes a feature or creative work, hand
  off to `brainstorming` next rather than starting implementation.
license: Apache-2.0
metadata:
