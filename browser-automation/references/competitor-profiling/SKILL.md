...
description: "When the user already has a specific list of competitor URLs (not auto-discovery) and wants SEO/traffic/backlink intelligence (via Firecrawl + DataForSEO) and review mining, not an interactive HTML report. Also use when the user mentions 'competitor profile,' 'competitor research,' 'profile this competitor,' 'analyze competitor,' 'competitive intelligence,' 'competitor deep dive,' 'competitor landscape,' 'competitor dossier,' 'competitive audit,' or 'research these competitors.' Input is a list of competitor URLs. Output is structured competitor profile markdown files. If the user does NOT already have a URL list and wants auto-discovery from their own company, or wants an interactive HTML report with a comparison matrix and screenshots, see `competitor-analysis` instead. For creating comparison/alternative pages from profiles, see competitors. For sales-specific battle cards, see sales-enablement."
metadata:
  version: 2.0.0
---
