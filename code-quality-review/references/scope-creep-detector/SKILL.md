...
description: >-
  ...
  keep, split, or justify guidance. Operates locally and offline. This is a
  pre-PR scope triage, not a quality/security review — for that, see
  `code-review-expert` or `code-review` after scope is settled.
license: Apache-2.0
metadata:
