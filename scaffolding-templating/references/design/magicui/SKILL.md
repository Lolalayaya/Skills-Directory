...
For real, embedded `.tsx` source of ~20 representative components across every category (not just install commands), see [references/source-catalog.md](references/source-catalog.md).
