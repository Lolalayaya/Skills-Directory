---
name: design
description: "All-in-one design skill covering brand identity, design tokens, UI styling, logo generation (55 styles, Gemini AI), corporate identity program (50 deliverables, CIP mockups), HTML presentations (Chart.js), banner design (22 styles, social/ads/web/print), icon design (15 styles, SVG, Gemini 3.1 Pro), social photos (HTML→screenshot, multi-platform). Bundles its own Logo/CIP/Banner/Icon/Social-Photo/Slides generation inline rather than delegating to the standalone skills, so it triggers everything in one shot. Use this when the request spans multiple design deliverables or you're not sure which narrow skill fits. If the user wants ONLY one narrow thing — just a banner (`banner-design`), just a slide deck (`slides`), just token specs (`design-system`), just brand voice/asset rules (`brand`) — prefer that standalone skill instead; it loads less context for the same single job. Actions: design logo, create CIP, generate mockups, build slides, design banner, generate icon, create social photos, social media images, brand identity, design system. Platforms: Facebook, Twitter, LinkedIn, YouTube, Instagram, Pinterest, TikTok, Threads, Google Ads."
